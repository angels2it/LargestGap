...
{
    public class SortCoClockWiseBottomDepot : SortCoClockWise
    {
        public SortCoClockWiseBottomDepot(LayoutConfig layout, ILayoutProvider layoutProvider) : base(layout, layoutProvider)
        {
            Console.WriteLine("SortCoClockWiseBottomDepot");
        }
        ...
        private Item GetStartingItem()
        {
            ...
            return items
                .OrderBy(e => LayoutProvider.GetRouteOfAisle(e.Aisle))
                .ThenBy(e => e.Bin)
